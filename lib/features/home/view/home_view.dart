...
class _HomeViewState extends State<HomeView>
  ...
  Widget build(BuildContext context) => GradientScaffold(
      defaultGradientStart: const [Color(0xffdee3ff), Colors.white],
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 28.h, child: const Tabs()),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => AnimePosterCard(anime: animeList[index]),
                ),
              ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => CharacterCard(character: charactersList[index]),
                ),
              ),
            ],
          ),
